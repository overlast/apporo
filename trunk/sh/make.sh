...
#g++ -O2 -Wall -g apporo_config_test.cc apporo_utf8.cc apporo_util.cc apporo_tsubomi_db.cc apporo_query.cc apporo_strdistance.cc apporo_search.cc -o ${ABSDIR}/../bin/apporo_configer -ltsubomi
